...
import { createStructureSchema, updateStructureSchema, listStructuresQuerySchema } from './structure.validation';
...
router.get('/', requireCapability('VIEW_SALARY_STRUCTURES'), validate(listStructuresQuerySchema, 'query'), controller.list);
